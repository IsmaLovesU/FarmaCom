...
export default function SucursalDeleteModal({
  ...
  if (!isOpen || !sucursal || typeof document === 'undefined') {
    return null;
  }
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4">
          <p className="text-sm text-slate-700 leading-relaxed">
            Esta acción eliminará la sucursal
            <span className="font-bold text-primary"> {sucursal.nombre_sucursal}</span>
            .
          </p>
          <p className="text-xs text-slate-500">
            Si la sucursal tiene información asociada, podrías afectar otros registros.
          </p>
