...
export default function ProductoActionBar({ busqueda, onBusquedaChange, onCrear }) {
  return (
    <motion.div
    ...
    >
      <div className="relative flex-1 group w-full">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-surface-container-lowest border-none rounded-xl text-sm font-medium placeholder:text-slate-400 focus:ring-2 focus:ring-primary/20 transition-all shadow-sm outline-none"
        />
      </div>
