...
export default function CategoriaDeleteModal({ isOpen, categoria, eliminando, onClose, onConfirm }) {
  if (!isOpen || !categoria || typeof document === 'undefined') return null;
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4">
          <p className="text-sm text-slate-700 leading-relaxed">
            ¿Eliminar la categoría <span className="font-bold text-primary">{categoria.nombre}</span>?
